							...
							<div class="col-sm-12">
								<div class="row">
									<div class="col-sm-6 form-group">
										<label class="required">First Name</label><input type="text" pattern='[A-Za-z\\s]*' title=" a-z,A-Z and not numbers."
											placeholder="Enter First Name Here.." class="form-control"
											name="first_name" required>
									</div>
									<div class="col-sm-6 form-group">
										<label class="required">Last Name</label> <input type="text" pattern='[A-Za-z\\s]*' title=" a-z,A-Z and not numbers."
								...
								<div class="row">
									<div class="col-sm-4 form-group">
										<label>City</label> <input type="text" pattern='[A-Za-z\\s]*' title=" a-z,A-Z and not numbers."
									...
									<div class="col-sm-4 form-group">
										<label>Zip</label> <input type="zip" pattern='[0-9]*' title=" 0-9 "
											placeholder="Enter Zip Code Here.." class="form-control"
											name="zip">
									</div>
								</div>
								<div class="form-group">
									<label class="required">User Name</label> <input type="text" pattern='[A-Za-z\\s]*' title=" a-z,A-Z and not numbers."
								...
								<div class="form-group">
									<label class="required">Phone Number</label> <input type="tel" pattern='[0-9]*' title=" 0-9 "
								...
								<div class="form-group">
									<label class="required">Aadhar Number</label> <input
										type="number" pattern='[0-9]*' title=" 0-9 " placeholder="Enter Aadhar Number Here.."
										class="form-control" name="aadhar" required>
								</div>
								<div class="form-group">
									<label class="required">PAN Number</label> <input
										type="text" placeholder="Enter PAN Card Number Here.."
										class="form-control" name="pan" required>
								</div>
								<div class="row">
									<div class="col-sm-6 form-group">
